...
<div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', alignItems: 'center', gap: '20px', padding: '20px' }}>
    <div id="image-cell">
        <img src="/assets/project1.jpeg" alt="Project 1" style={{ width: '400px', height: '600px' }}></img>
        <p>Hooked Adolescence</p>
        <p>Acrylic Paint, January 2025</p>
    </div>

    <div id="image-cell">
        <img src="/assets/project2.jpeg" alt="Project 2" style={{ width: '500px', height: '375px' }}></img>
        <p>Riot Grrrl</p>
        <p>Mixed Media, April 2024</p>
    </div>
    
    <div id="image-cell">
        <img src="/assets/project3.jpeg" alt="Project 3" style={{ width: '400px', height: '600px' }}></img>
        <p>The Things that go on Inside my Mind</p>
        <p>Mixed Media, April 2024</p>
    </div>
    <div id="image-cell">
        <img src="/assets/project5.jpeg" alt="Project 5" style={{ width: '400px', height: '600px' }}></img>
...
const contemporary = <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', alignItems: 'center', gap: '20px', padding: '20px' }}>
    <div id="image-cell">
        <img src="/assets/project4.jpeg" alt="Project 4" style={{ width: '400px', height: '600px' }}></img>
        <p>Untitled</p>
        <p>Charcoal, October 2024</p>
    </div>
    <div id="image-cell">
        <img src="/assets/project6.jpeg" alt="Project 6" style={{ width: '800px', height: '600px' }}></img>
        <p>Skull</p>
        <p>Charcoal, November 2023</p>
    </div>
    <div id="image-cell">
        <img src="/assets/project7.jpeg" alt="Project 7" style={{ width: '400px', height: '600px' }}></img>
        <p>Untitled</p>
        <p>Charcoal, October 2024</p>
    </div>
</div>;
...
export function showPage(pageContent: string) {
    console.log(`Showing page content: ${pageContent}`);
